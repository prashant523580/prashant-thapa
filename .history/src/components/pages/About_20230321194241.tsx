...
export default function AboutComponent() {
    return (
        <Section id={"About"}>
                    ...
                    <div  data-aos="fade-up" data-aos-duration="1000" className='relative h-64 lg:h-auto md:h-auto w-80'>
                        <Parallax speed={-5}>
                            ...
                            <div  className='bg-black overflow-hidden  px-5 py-5 absolute left-0 lg:-left-20 md:-left-20 top-0 -translate-y-[50%]'>
                                ...
                                <p  data-aos="fade-up" data-aos-duration="1400"  className='text-white'>Hello there! My name is Peashant Thapa, and I am a talented web developer from Nepal with a passion for building high-quality websites for small and medium-sized businesses..</p>
                            </div>
                        </Parallax>
                    </div>
                </div>
            ...
            <p>My primary focus is on delivering user-friendly, functional, and aesthetically pleasing websites that enhance your online presence and drive traffic and sales. I strive to provide exceptional customer service, and I am always available to answer any questions or concerns you may have throughout the project.</p>
            <p>So, whether you need a simple brochure website or a complex eCommerce platform, I have the expertise and knowledge to deliver a website that exceeds your expectations. If you are looking for a reliable and experienced web developer to bring your online vision to life, then look no further than me. Let&apos;s work together and bring your project to life!</p>
            </div>
