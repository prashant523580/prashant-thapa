...
export default function ContactComponent() {
  ...
  <div className="container px-5 py-2 mx-auto">
    ...
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      {/* <p className='my-4'>Hire Me</p> */}
      <div className="flex flex-wrap -m-2 shadow-xl shadow-sky-200 bg-sky-400 bg-opacity-10 border-4 border-sky-500 rounded px-3 overflow-hidden">
        ...
        <div  data-aos="fade-up" data-aos-duration="1000" className="p-2 w-full">
          <button className="flex mx-auto text-white bg-sky-500 border-0 py-2 px-8 focus:outline-none hover:bg-sky-600 rounded text-lg my-2">send</button>
        </div>
