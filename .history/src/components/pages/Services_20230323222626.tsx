...
<div className="pt-20  lg:pt-[120px] pb-12 lg:pb-[90px]">
   <div className="container mx-auto ">
      ...
      <CardComponent
         ...
         description={"Hello there! I am a skilled website developer with a passion for creating visually stunning and user-friendly websites. I specialize in HTML, CSS, JavaScript, and various web development frameworks such as ReactJS, NextJS, and Tailwind CSS. With my expertise in web development, I can help bring your online vision to life and deliver a website that reflects your unique brand identity. If you're looking for a reliable and experienced web developer for your portfolio website, then I'm the perfect match for you!"}
      ...
      <CardComponent
         title=' Application'
         description={"A popular cross-platform development framework. I specialize in creating high-quality, user-friendly applications for both iOS and Android platforms using React Native. With my proficiency in this framework, I can help bring your application idea to life and deliver an exceptional mobile experience for your users. If you're looking for a reliable and experienced React Native developer for your next project, then I'm the perfect match for you!"}
    ...
    <div className="flex flex-wrap justify-center text-center ">
      <div data-aos="fade-up" data-aos-duration="800"  className="p-4  md:w-1/4 sm:w-1/2 w-1/2  my-2">
        <div className="border-2  border-sky-500 shadow-lg shadow-sky-400 px-4 py-6 rounded-lg">
          ...
          <p className="leading-relaxed text-gray-500">Clients</p>
        </div>
      </div>
      <div data-aos="fade-up" data-aos-duration="1000"  className="p-4 md:w-1/4 sm:w-1/2 w-1/2 my-2">
        <div className="border-2 border-sky-500 shadow-lg shadow-sky-600 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-200">2</h2>
          <p className="leading-relaxed text-gray-500">reviews</p>
        </div>
      </div>
      <div data-aos="fade-up" data-aos-duration="1200"  className="p-4 md:w-1/4 sm:w-1/2 w-1/2 my-2">
        <div className="border-2 border-sky-500 shadow-lg shadow-sky-400 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-300">4</h2>
          <p className="leading-relaxed text-gray-500 ">Projects</p>
        </div>
      </div>
      <div data-aos="fade-up" data-aos-duration="1400"  className="p-4 md:w-1/4 sm:w-1/2 w-1/2 my-2">
        <div className="border-2 border-sky-600 shadow-lg shadow-sky-700 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-300">6</h2>
          <p className="leading-relaxed text-gray-500">Places</p>
        </div>
      </div>
    </div>
  </div>
