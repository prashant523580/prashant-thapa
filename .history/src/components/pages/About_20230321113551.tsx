...
export default function AboutComponent() {
    return (
        <Section id={"About"}>
            ...
            <div className='py-20'>
                <div className='relaive flex justify-center items-center flex-wrap md:flex-nowrap'>
                    ...
                    <div className='relative w-[100%] md:w-[40%] lg:w-[50%] h-96 '>
                        ...
                        <Image data-aos-duration="1000"  data-aos="zoom-in" src={"/images/carousel/carousel-1.jpg"} fill alt='image abouts' />
                        {/* </ParallaxBanner> */}
                    </div>
                    <div  data-aos="fade-up" data-aos-duration="1000" className='relative h-64 lg:h-auto md:h-auto w-80'>
                        <Parallax speed={-5}>
                            ...
                            <div  className='bg-black  px-5 py-5 absolute left-0 lg:-left-20 md:-left-20 top-0 -translate-y-[50%]'>
                                ...
                                <div  data-aos="fade-up" data-aos-duration="1000"  className="h-1 bg-blue-300 w-24    "></div>
                                <h1  data-aos="fade-up" data-aos-duration="1000"  className='text-white text-xl uppercase'>Who Am I?</h1>
                                <p  data-aos="fade-up" data-aos-duration="1000"  className='text-white'>Hi I&apos;m Jackson Ford On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word  and the Little Blind Text should turn around and return to its own, safe country.In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content</p>
                            </div>
                        </Parallax>
                    </div>
                </div>
            </div>
            <div className='bg-black flex items-center justify-center   py-3 px-4'>
                <div className="w-52 h-32 flex flex-col mx-2 my-3 items-center justify-center bg-black dark:bg-white shadow-lg border-b-8 border-b-sky-400 border-blue-400  px-3 py-2">
                    <WebIcon color='info' />
            ...
            <div className='bg-black px-3 py-5 w-[80%] md:w-[50%] lg:w[60%] mx-auto mt-10 rounded-md'>
