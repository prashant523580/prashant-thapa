...
<div className="gap-8 sm:grid sm:grid-cols-2 px-10 py-6">
    <div>
        <dl>
            ...
            <dd className="flex items-center mb-3">
                <div className="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                    <div className="bg-sky-400 h-2.5 rounded dark:bg-blue-500" style={{width: "89%"}}></div>
                </div>
        ...
        <dl>
            ...
            <dd className="flex items-center mb-3">
                <div className="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                    <div className="bg-sky-400 h-2.5 rounded dark:bg-blue-500" style={{width: "70%"}}></div>
                </div>
        ...
        <dl>
            ...
            <dd className="flex items-center mb-3">
                <div className="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                    <div className="bg-sky-400 h-2.5 rounded dark:bg-blue-500" style={{width: "80%"}}></div>
                </div>
        ...
        <dl>
            ...
            <dd className="flex items-center">
                <div className="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                    <div className="bg-sky-400 h-2.5 rounded dark:bg-blue-500" style={{width: "60%"}}></div>
                </div>
    ...
    <div>
        <dl>
            ...
            <dd className="flex items-center mb-3">
                <div className="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                    <div className="bg-sky-400 h-2.5 rounded dark:bg-blue-500" style={{width: "63%"}}></div>
                </div>
        ...
        <dl>
            ...
            <dd className="flex items-center mb-3">
                <div className="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                    <div className="bg-sky-400 h-2.5 rounded dark:bg-blue-500" style={{width: "65%"}}></div>
                </div>
        ...
        <dl>
            ...
            <dd className="flex items-center">
                <div className="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                    <div className="bg-sky-400 h-2.5 rounded dark:bg-blue-500" style={{width: "47%"}}></div>
                </div>
        ...
        <dl>
            ...
            <dd className="flex items-center">
                <div className="w-full bg-gray-200 rounded h-2.5 dark:bg-gray-700 mr-2">
                    <div className="bg-sky-400 h-2.5 rounded dark:bg-blue-500" style={{width: "40%"}}></div>
                </div>
