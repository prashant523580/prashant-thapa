...
export default function AboutComponent() {
    return (
        <Section id={"About"}>
            ...
            <div className='bg-black flex flex-wrap items-center space-y-2 space-x-2 justify-center py-3 px-4'>
                <div className="w-52 h-32 flex flex-col items-center justify-center bg-black dark:bg-white shadow-lg border-b-8 border-b-sky-400 border-blue-400  px-3 py-2">
                    <WebIcon color='info' />
