                        ...
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                ...
                                <ul data-aos="fade-up" data-aos-duration="1000" className="leading-relaxed dark:text-gray-400 list-disc ml-4">
                                    ...
                                    <li data-aos="fade-up" data-aos-duration="1000">Created custom website designs and integrated third-party apps and plugins to enhance website functionality.</li>
                                    <li data-aos="fade-up" data-aos-duration="1000">Ensured website design was responsive and mobile-friendly</li>
                                    <li data-aos="fade-up" data-aos-duration="1000">Provided ongoing website maintenance and support</li>
                                </ul>
                            </div>
                        </div>
                    </div>
