                    ...
                    <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 className="font-medium title-font text-gray-900 mb-1 text-xl">Full Stack Developer</h2>
                                <p className="leading-relaxed">Built and maintained web applications using React.js and Next.js on the front-end and Node.js and MongoDB on the back-end.<br/>
