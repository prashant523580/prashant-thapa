        ...
        <Carousel>
          <CarouselItem>
            ...
            <div className='h-full z-20 w-full flex flex-col justify-center items-center'>
              ...
              <div className="relative  rounded-md overflow-hidden px-4 py-5 shadow-xl shadow-sky-500  flex flex-col justify-center items-center">
          ...
          <CarouselItem>
            ...
            <div className="relative rounded-md overflow-hidden px-4 py-5 shadow-lg shadow-gray-500  flex flex-col justify-center items-center">
            <div className="absolute w-full h-full opacity-40 z-10 bg-black"></div>
                <div className='z-20'>
                <CodeIcon style={{
                  color: "var(--logo-color)",
