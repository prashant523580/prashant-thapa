  ...
  return (
    <Section id="Home">
      <ParallaxBanner className='relative'>
        ...
        <Carousel>
          <CarouselItem>
            <ParallaxBannerLayer image="/images/carousel/carousel-1.jpg" speed={-30} />
            ...
            <div className='h-full  z-20 w-full flex flex-col justify-center items-center'>
              ...
              <div className="relative  rounded-md overflow-hidden px-4 py-5 shadow-xl shadow-sky-500 flex">
                <div className="absolute left-0 top-0 w-ful   l h-full opacity-40 z-10 bg-black"></div>
                <div className='flex flex-col justify-center items-center z-20'>
                  ...
                  <div className='h-2 bg-sky-700 w-[50%]'></div>
                  <CodeOffIcon style={{
                    color: "var(--logo-color)",
                    fontSize: "78px"
                  }} />
          ...
          <CarouselItem>
            <ParallaxBannerLayer image="/images/carousel/carousel-3.jpg" speed={-30} />
