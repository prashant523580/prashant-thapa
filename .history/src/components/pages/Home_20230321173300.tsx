        ...
        <Carousel>
          <CarouselItem>
            ...
            <div className='h-full z-20 w-full flex flex-col justify-center items-center'>
              ...
              <div className="bg-black px-4 py-5 border-8  border-sky-500 shadow-sky-500  flex flex-col justify-center items-center">
          ...
          <CarouselItem>
            ...
            <div className="bg-black px-4 py-5 border-8 shadow-lg shadow-sky-500  border-sky-500 flex flex-col justify-center items-center">
