    ...
    <Section id="Home">
        ...
        <Carousel>
            ...
            <CarouselItem> 
                ...
                <h2 data-aos="fade-up" className='text-2xl text-white'>I&apos;m</h2>
                <h1  data-aos="fade-up" className='text-4xl md:text-5xl lg:text-7xl text-white'>a Web Developer</h1>
                <h2  data-aos="fade-up" className='text-5xl text-white'>&</h2>
                <h1  data-aos="fade-up" className='text-4xl md:text-5xl lg:text-7xl text-white'>Android Developer.</h1>
