                    ...
                    <div  data-aos="fade-up" data-aos-duration="1000" className='relative h-64 lg:h-auto md:h-auto w-80'>
                        <Parallax speed={-5}>
                            ...
                            <div  className='bg-black overflow-hidden  px-5 py-5 absolute left-0 lg:-left-20 md:-left-20 top-0 -translate-y-[50%]'>
                                ...
                                <p  data-aos="fade-up" data-aos-duration="1400"  className='text-white'>Hello there! My name is Prashant Thapa, and I am a talented web developer from Nepal with a passion for building high-quality websites for small and medium-sized businesses..</p>
                            </div>
                        </Parallax>
                    </div>
                </div>
