    ...
    <div className="flex flex-wrap justify-center text-center ">
      <div className="p-4 bg-black md:w-1/4 sm:w-1/2 w-1/2  my-2">
        <div className="border-2  border-gray-200 px-4 py-6 rounded-lg">
          ...
          <p className="leading-relaxed dark:text-gray-50">Downloads</p>
        </div>
      </div>
      <div className="p-4 bg-black md:w-1/4 sm:w-1/2 w-1/2 my-2">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <p className="leading-relaxed dark:text-gray-50">Users</p>
        </div>
      </div>
      <div className="p-4 bg-black md:w-1/4 sm:w-1/2 w-1/2 my-2">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
          ...
          <p className="leading-relaxed dark:text-gray-50 ">Files</p>
        </div>
      </div>
      <div className="p-4 bg-black md:w-1/4 sm:w-1/2 w-1/2 my-2">
        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
