      ...
      <ParallaxBanner className='relative'>
        ...
        <Carousel>
          <CarouselItem>
            ...
            <div className='h-full z-20 w-full flex flex-col justify-center items-center'>

              <div className="relative px-4 py-5 shadow-xl shadow-sky-500  flex flex-col justify-center items-center">
                <div className="absolute w-full h-full opacity-40 z-10 bg-black"></div>
                <div className='z-20'>
          ...
          <CarouselItem>
            ...
            <div className="relative px-4 py-5 shadow-lg shadow-gray-500  flex flex-col justify-center items-center">
            <div className="absolute w-full h-full opacity-70 z-10 bg-black"></div>
                <div className='z-20'>
                <CodeIcon style={{
                  color: "var(--logo-color)",
                  fontSize: "78px",
                ...
                <h1 data-aos="fade-right" className='text-3xl md:text-5xl lg:text-7xl text-white'>a Web Developer</h1>
