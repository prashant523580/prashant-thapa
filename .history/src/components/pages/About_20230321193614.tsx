                    ...
                    <div  data-aos="fade-up" data-aos-duration="1000" className='relative h-64 lg:h-auto md:h-auto w-80'>
                        <Parallax speed={-5}>
                            ...
                            <div  className='bg-black overflow-hidden  px-5 py-5 absolute left-0 lg:-left-20 md:-left-20 top-0 -translate-y-[50%]'>
                                ...
                                <p  data-aos="fade-up" data-aos-duration="1400"  className='text-white'>Hi I&apo;m a developer from Nepal with experience building websites for small and medium-sized businesses. I&apos;m experienced in HTML,CSS,JavaScript,Reactjs and SEO. I fully project manage your brief from start to finish.</p>
                            </div>
                        </Parallax>
                    </div>
                </div>
