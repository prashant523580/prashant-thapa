    ...
    return (
        <Section id={"About"}>
            ...
            <div>
                ...
                <div className='bg-dark flex space-x-2 justify-center'>
                    <div className="bg-black border-b-4 border-b-sky-400 border-blue-400  px-3 py-2">
                            <WebIcon color='info'/>
                            <h1 className='text-blue-300'>Web Design / Development</h1>
                    </div>
                    <div className="bg-black border-b-4 border-b-sky-400 border-blue-400  px-3 py-2">
                            <WebIcon color='info'/>
                            <h1 className='text-blue-300'>Application Development</h1>
                    </div>
