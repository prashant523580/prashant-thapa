...
export default function PortfolioComponent(props: any) {
    ...
    const [applications, setIllustrate] = React.useState<any>([]);
                    ...
                    <TabContext value={value}>
                        ...
                        <TabPanel value="3">
                            <CardContainer>
                                ...
                                {
                                    applications.length > 0 && videos.slice(0, numbOfprojects).map((product: any, ind: any) => {
                                        return (
                                            <ProductCard
                                                key={ind}
                                                product={product}
