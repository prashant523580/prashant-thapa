    ...
    return (
        <Section id={"About"}>
            ...
            <div className='bg-dark flex flex-wrap space-y-2 space-x-2 justify-center py-3 px-4'>
                <div className="w-52 bg-black dark:bg-white shadow-lg border-b-8 border-b-sky-400 border-blue-400  px-3 py-2">
                    <WebIcon color='info' />
                    <h1 className='text-blue-300 text-center'>Web Design & Development</h1>
                </div>
                <div className="w-52 bg-black shadow-lg border-b-8 border-b-sky-400 border-blue-400  px-3 py-2">
