...
<div className="pt-20  lg:pt-[120px] pb-12 lg:pb-[90px]">
   <div className="container mx-auto ">
      ...
      <div className="flex flex-wrap justify-center ">
         <div  data-aos="fade-up" data-aos-duration="1000" className="w-full md:w-1/2 lg:w-1/3 px-4 ">
            <div
               className="
               p-10 md:px-7 xl:px-10  bg-white shadow-md hover:shadow-lg mb-8 border-b-8 border-sky-500
               "
               >
               <div
                  className="w-[100px] h-[100px] flex items-center justify-center bg-black rounded-2xl mb-8"
                  >
                    <WebIcon fontSize='large' style={{
                     fontSize: 80,
                     color:"white"
                    }} color="info"/>
               </div>
  ...
  <div className="container px-5 py-24 mx-auto ">
    ...
    <div className="flex flex-wrap justify-center text-center ">
      <div className="p-4 bg-black md:w-1/4 sm:w-1/2 w-1/2  my-2">
        <div className="border-2  border-sky-500 px-4 py-6 rounded-lg">
          ...
          <h2 className="title-font font-medium text-3xl text-gray-300">2.7K</h2>
          <p className="leading-relaxed dark:text-gray-500">Downloads</p>
        </div>
      </div>
      <div className="p-4 bg-black md:w-1/4 sm:w-1/2 w-1/2 my-2">
        <div className="border-2 border-sky-500 px-4 py-6 rounded-lg">
