...
let data = [
 
    {
        ...
        "category": "website",
        "img": "/images/project/websites/buddha.png",
        "href":"https://buddhatattoohouse.web.app/"
    },
    {
        "label" : "Tripods Nepal",
        "category": "website",
        "img": "/images/project/websites/tripods.png",
...
console.log(props)
    ...
    return (
        <div className='flex flex-col rounded-md bg-blach-500 overflow-hidden  shadow-lg shadow-sky-600'
            data-aos="zoom-in" data-aos-duration="1000"
        >
      
            <div className=' relative w-[100%] h-40 rounded-md overflow-hidden'
                style={{
            ...
            >
                ...
                <Image src={props.product.img} fill sizes='100vw' alt='product' />
                {/* <p className='absolute bottom-4 right-4 bg-orange-500 text-white px-2 rounded-md'>Rs.{props.product.price}</p> */}
            </div>
            <div className='px-2 py-4' >
                <h1 className='font-bold truncate text-gray-200'>{props.product.label}</h1>
                <Divider/>
                <p className='text-sm text-gray-300'> Category : {props.product.category}</p>
            </div>
            <Link  rel="noopener noreferrer" target={"_blank"} href={props.product.href} style={{
                ...
                color: "var(--dark)",
                marginTop: "auto",
            }} className="text-center text-white">Add to bag</Link>
        </div>
    );
}
                        ...
                        <TabPanel value="1">
                            <CardContainer>
...

                                {
                                    ...
                                    }) : <p className='my-5 text-white'>No Application Created.</p>
                                }
                                </CardContainer>
                                ...
                                </CardContainer>
                            {
                                isLoading ? <div>
                                    ...
                                    applications.length > numbOfprojects ?
                                        ...
                                        <div>
                                            <p className='text-white'>You have seen all contents.</p>
                                        </div>
                            }
                        </TabPanel>
