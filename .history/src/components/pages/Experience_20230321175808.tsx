            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto flex flex-wrap">
                        ...
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                ...
                                <ul className="leading-relaxed dark:text-gray-400 list-disc ml-4">
                                    <li>
                                        Built and maintained web applications using React.js and Next.js on the front-end and Node.js and MongoDB on the back-end.<br/>
                                        </li>
                                        <li>

                                    Implemented responsive and user-friendly interfaces using HTML, CSS, and TailwindCSS.
                                        </li>
                                        <li>

                                    Worked collaboratively with cross-functional teams to ensure optimal user experience and functionality.
                                        </li>
                                        <li>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000" className="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div data-aos="fade-right" data-aos-duration="1000" className="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-sky-400 text-white relative z-10 title-font font-medium text-sm">2</div>
                        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 className="font-medium title-font text-gray-900 dark:text-white mb-1 text-xl">Ecommerce Website</h2>
                                <Divider/>
                                <ul className="leading-relaxed dark:text-gray-400 list-disc ml-4">
                                    <li>Collaborated with clients to understand their business needs and goals and developed website solutions that met those needs.</li>
                                    <li>Created custom website designs and integrated third-party apps and plugins to enhance website functionality.</li>
                                    <li>Ensured website design was responsive and mobile-friendly</li>
