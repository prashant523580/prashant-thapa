                ...
                <nav className={styles.nav} ref={this.navRef} style={{
                    ...
                    >
                        ...
                        <div className={styles.contact_container}>
                            ...
                            <div className={styles.contact}>
                                <Phone />
                                <a href={"tel:+9779816514719"}>9816514719</a>
                            </div>
                            <div className={styles.contact}>
                                <MailOutlineOutlined />
                                <a href={"mailto: prashant.thapa62758@gmail.com"} className="lowercase">prashant.thapa62758@gmail.com</a>
                        ...
                        <div className={styles.social_content}>
                            ...
                            <div style={{
                                ...
                                <Link rel="noopener noreferrer" target="_blank" href="https://www.facebook.com/prashant7hapa/" className={styles.facebook + " " + styles.icon}> <FacebookRounded /></Link>
                                <Link rel="noopener noreferrer" target="_blank" href="https://www.facebook.com/prashant7hapa/" className={styles.instagram + " " + styles.icon}><Instagram /></Link>
                            </div>
                        </div>
                    </div>
