                ...
                <nav className={styles.nav} ref={this.navRef} style={{
                    ...
                    >
                        ...
                        <div className={styles.contact_container}>
                            ...
                            <a target={"_blank"} href={"mailto: prashant.thapa62758@gmail.com"} className={styles.contact}>
                                <MailOutlineOutlined />
                        ...
                        <div className={styles.social_content}>
                            ...
                            <div style={{
                                ...
                                <a rel="noopener noreferrer"  target="_blank" href="https://www.facebook.com/prashant7hapa" className={styles.instagram + " " + styles.icon}><Instagram />
                                </a>
                            </div>
                        </div>
                    </div>
