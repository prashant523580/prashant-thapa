                    ...
                    >
                        ...
                        <div className={styles.social_content}>
                            ...
                            <div style={{
                                ...
                                <Link  target="_blank" href="https://www.facebook.com/prashant7hapa" className={styles.facebook + " " + styles.icon}> <FacebookRounded />
                                </Link>
                                <Link  target="_blank" href="https://www.facebook.com/prashant7hapa" className={styles.instagram + " " + styles.icon}><Instagram />
                                </Link>
                            </div>
                        </div>
                    </div>
