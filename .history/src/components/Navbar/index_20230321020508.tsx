...
const links = ["Home", "About", "Services", "Skills", "Education", "Experience", "Work", "Contact"];
        ...
        return (
            <>
                ...
                <nav className={styles.nav} ref={this.navRef} style={{
                    position: this.state.scroll > 100 ? "fixed" : "sticky",
                    ...
                    >
                        ...
                        <div className={styles.contact_container}>
                            ...
                            <Link href={"tel:+9779816514719"} className={styles.contact}>
                                <Phone />
                                <div>9816514719</div>
                            </Link>
                            <Link href={"mailto: prashant.thapa62758@gmail.com"} className={styles.contact}>
                                <MailOutlineOutlined />
                                <div className="lowercase">prashant.thapa62758@gmail.com</div>
                        ...
                        <div className={styles.social_content}>
                            ...
                            <div style={{
                                ...
                                <Link rel="noopener noreferrer"  target="_blank" href="https://www.facebook.com/prashant7hapa" className={styles.facebook + " " + styles.icon}> <FacebookRounded />
                                </Link>
                                <Link rel="noopener noreferrer"  target="_blank" href="https://www.facebook.com/prashant7hapa" className={styles.instagram + " " + styles.icon}><Instagram />
                                </Link>
                            </div>
                        </div>
                    </div>
                ...
                }} className={`transition-all z-50 fixed ${this.state.scroll > 300 ? "bottom-10" : "-bottom-20"} right-10 w-10 h-10 bg-black text-sky-300 rotate-45 flex justify-center items-center cursor-pointer hover:bg-gray-900`}>
