...
export default function CardComponent(props: PropsTypes) {
    ...
    return (
              ...
              <div  data-aos="fade-up" data-aos-duration="1000" className="hover:transition-shadow w-full md:w-1/2 lg:w-1/3 px-4 hover:shadow-lg hover:shadow-sky-500 rounded-md">
            <div
               className="
